                ...
                await Navigator.of(context).push(
                  MaterialPageRoute<void>(
                    builder: (BuildContext context) =>
                        LocalNotificationInfoPage(receivedNotification.payload),
                  ),
                );
              },
              child: const Text('Ok'),
  ...
  void _configureSelectNotificationSubject() {
    selectNotificationStream.stream.listen((String? payload) async {
      await Navigator.of(context).push(MaterialPageRoute<void>(
        builder: (BuildContext context) => LocalNotificationInfoPage(payload),
      ));
    });
  }
                ...
                children: <Widget>[
                  ...
                  if (!kIsWeb && Platform.isLinux) ...<Widget>[
                    ...
                    FutureBuilder<LinuxServerCapabilities>(
                      future: LocalNotificationCommonServices()
                    ...
                    PaddedElevatedButton(
                      ...
                      onPressed: () async {
                        await LocalNotificationCommonServices()
