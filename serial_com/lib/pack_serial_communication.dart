...
//   DataFormat format = DataFormat.HEX_STRING;
...
//     final dataBytes = utf8.encode(json.encode(jsonData));
...
//     // Construct the message as a list of integers (bytes)
//     final messageBytes = <int>[
//       0x02, // STX
//       lengthHigh, // Length high byte
//       lengthLow, // Length low byte
//       ...dataBytes, // Data
//       0x03 // ETX
//     ];

//     // Convert the byte message to a hex string
//     final hexMessage = messageBytes
//         .map((byte) => byte.toRadixString(16).padLeft(2, '0'))
//         .join();

//     print(hexMessage);

//     // Send the hex string message
//     serialCommunication.sendCommand(message: hexMessage);
//   }
